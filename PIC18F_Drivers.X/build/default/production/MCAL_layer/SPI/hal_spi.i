...
# 1 "MCAL_layer/SPI/../std_libiraries.h" 1
# 11 "MCAL_layer/SPI/../std_libiraries.h"
...
# 11 "MCAL_layer/SPI/../std_libiraries.h" 2
...
# 12 "MCAL_layer/SPI/../std_libiraries.h" 2
...
# 13 "MCAL_layer/SPI/../std_libiraries.h" 2
...
# 14 "MCAL_layer/SPI/../std_libiraries.h" 2
...
# 33 "MCAL_layer/SPI/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW,
    GPIO_HIGH
}logic_t;
...
# 58 "MCAL_layer/SPI/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
__attribute__((inline)) static void SPI_Interrupt_CFG (const spi_t *_spi_cfg);


static void (*SPI_DefaultInterruptHandler)(void) = ((void*)0);
...
Std_ReturnType SPI_Read_Byte_Blocking(const spi_t *_spi_cfg,const uint8 *_data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
     ...
     if((((void*)0) == _spi_cfg)|| (((void*)0) == _data)){
         ret= (Std_ReturnType)0x00;
     }
     else{
