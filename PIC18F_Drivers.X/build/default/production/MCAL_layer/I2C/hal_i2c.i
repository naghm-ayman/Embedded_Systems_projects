...
# 1 "MCAL_layer/I2C/../std_libiraries.h" 1
# 11 "MCAL_layer/I2C/../std_libiraries.h"
...
# 11 "MCAL_layer/I2C/../std_libiraries.h" 2
...
# 12 "MCAL_layer/I2C/../std_libiraries.h" 2
...
# 13 "MCAL_layer/I2C/../std_libiraries.h" 2
...
# 14 "MCAL_layer/I2C/../std_libiraries.h" 2
...
# 33 "MCAL_layer/I2C/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW,
    GPIO_HIGH
}logic_t;
...
# 58 "MCAL_layer/I2C/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
static __attribute__((inline)) void MSSP_I2C_Master_mode_clock_cfg(const mssp_i2c_t *i2c_obj);
static __attribute__((inline)) void MSSP_I2C_Interrupt_cfg(const mssp_i2c_t *i2c_obj);
static __attribute__((inline)) void MSSP_I2C_Slave_mode(const mssp_i2c_t *i2c_obj);


static void (*I2C_Report_Write_Collision_InterruptHandler)(void) = ((void*)0);
static void (*I2C_InterruptHandler)(void) = ((void*)0);
...
Std_ReturnType MSSP_I2C_Init(const mssp_i2c_t *i2c_obj){
    ...
    if (((void*)0) == i2c_obj) {
        ...
        ( SSPCON1bits.SSPEN = 0);
        if (1 == i2c_obj->i2c_config.i2c_mode) {

            MSSP_I2C_Master_mode_clock_cfg(i2c_obj);
        } else if (0 == i2c_obj->i2c_config.i2c_mode) {

            if (1 == i2c_obj->i2c_config.i2c_general_call) {
                (SSPCON2bits.GCEN = 1);
            } else if (0 == i2c_obj->i2c_config.i2c_general_call) {
                (SSPCON2bits.GCEN = 0);
            } else {
        ...
        if (0 == i2c_obj->i2c_config.i2c_slew_rate) {
            (SSPSTATbits.SMP = 0);
        } else if (1 == i2c_obj->i2c_config.i2c_slew_rate) {
            (SSPSTATbits.SMP = 1);
        } else {

        }

        if (1 == i2c_obj->i2c_config.i2c_SMBus_control) {
            (SSPSTATbits.CKE = 1);
        } else if (0 == i2c_obj->i2c_config.i2c_SMBus_control) {
            (SSPSTATbits.CKE = 0);
        } else {
