...
# 1 "MCAL_layer/ADC/../std_libiraries.h" 1
# 11 "MCAL_layer/ADC/../std_libiraries.h"
...
# 11 "MCAL_layer/ADC/../std_libiraries.h" 2
...
# 12 "MCAL_layer/ADC/../std_libiraries.h" 2
...
# 13 "MCAL_layer/ADC/../std_libiraries.h" 2
...
# 14 "MCAL_layer/ADC/../std_libiraries.h" 2
...
# 58 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
Std_ReturnType ADC_IsConversionDone(const adc_config_t *_adc, uint8 *conversion_st){
    Std_ReturnType ret = (Std_ReturnType)0x01;
     ...
     if( (((void*)0) == _adc) || (((void*)0) == conversion_st)){
         ret= (Std_ReturnType)0x00;
     }
     else{
       *conversion_st = (uint8)(!((ADCON0bits.GO_nDONE)));
     }
     return(ret);
}
Std_ReturnType ADC_GetConversionResult(const adc_config_t *_adc, adc_result_t *conversion_st){
...
static __attribute__((inline)) void configure_voltage_reference(const adc_config_t *_adc){
    if(0x01U == _adc->voltage_refrence){
        do{ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
    }
    else if(0x00U == _adc->voltage_refrence){
