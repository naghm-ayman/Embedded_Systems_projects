...
# 14 "ECU_layer/DC_MOTOR/../../MCAL_layer/GPIO/../std_libiraries.h" 2
    ...
    Std_ReturnType ret = (Std_ReturnType)0x01;
     ...
     if(((void*)0) == _dc_motor){
         ret= (Std_ReturnType)0x00;
          ...
          ret = gpio_pin_intialize(&(_dc_motor->dc_motor[0x00U]));
          ret = gpio_pin_intialize(&(_dc_motor->dc_motor[0x01U]));
...
Std_ReturnType dc_motor_move_right(const dc_motor_t *_dc_motor){
     ...
     if(((void*)0) == _dc_motor){
         ...
         ret = gpio_pin_write_logic(&(_dc_motor->dc_motor[0x00U]),GPIO_HIGH);
         ret = gpio_pin_write_logic(&(_dc_motor->dc_motor[0x01U]),GPIO_LOW);
...
Std_ReturnType dc_motor_move_left(const dc_motor_t *_dc_motor){
     ...
     if(((void*)0) == _dc_motor){
        ...
        ret = gpio_pin_write_logic(&(_dc_motor->dc_motor[0x00U]),GPIO_LOW);
         ret = gpio_pin_write_logic(&(_dc_motor->dc_motor[0x01U]),GPIO_HIGH);
     }
     return(ret);
}
Std_ReturnType dc_motor_stop(const dc_motor_t *_dc_motor){
