...
# 1 "MCAL_layer/CCP1/../std_libiraries.h" 1
# 11 "MCAL_layer/CCP1/../std_libiraries.h"
...
# 11 "MCAL_layer/CCP1/../std_libiraries.h" 2
...
# 12 "MCAL_layer/CCP1/../std_libiraries.h" 2
...
# 13 "MCAL_layer/CCP1/../std_libiraries.h" 2
...
# 14 "MCAL_layer/CCP1/../std_libiraries.h" 2
...
# 14 "MCAL_layer/CCP1/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/CCP1/../../MCAL_layer/GPIO/../device_config.h" 1
# 14 "MCAL_layer/CCP1/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/CCP1/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_layer/CCP1/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 58 "MCAL_layer/CCP1/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
Std_ReturnType CCP_Init(const ccp_t *_ccp1_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
     ...
     if(((void*)0) == _ccp1_obj){
         ...
         if(0x00 == _ccp1_obj->ccp_mode) {
            ret = CCP_Capture_mode_config(_ccp1_obj);
         }

         else if(0x01 == _ccp1_obj->ccp_mode){
...
# 131 "MCAL_layer/CCP1/hal_ccp1.c"
Std_ReturnType CCP_IsCompareCompleted(uint8 *compare_status){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 238 "MCAL_layer/CCP1/hal_ccp1.c"
void CCP1_ISR(void){
    (PIR1bits.CCP1IF = 0);
...
# 281 "MCAL_layer/CCP1/hal_ccp1.c"
static void CCP_interrupt_config(const ccp_t *_ccp_obj){

    (PIE1bits.CCP1IE = 1);
    (PIR1bits.CCP1IF = 0);
    CCP1_InterruptHandler = _ccp_obj->CCP1_InterruptHandler;
# 299 "MCAL_layer/CCP1/hal_ccp1.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
...
# 320 "MCAL_layer/CCP1/hal_ccp1.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
