...
# 1 "MCAL_layer/USART/../std_libiraries.h" 1
# 11 "MCAL_layer/USART/../std_libiraries.h"
...
# 11 "MCAL_layer/USART/../std_libiraries.h" 2
...
# 12 "MCAL_layer/USART/../std_libiraries.h" 2
...
# 13 "MCAL_layer/USART/../std_libiraries.h" 2
...
# 14 "MCAL_layer/USART/../std_libiraries.h" 2
...
# 58 "MCAL_layer/USART/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 8 "MCAL_layer/USART/hal_usart.c" 2
    ...
    static void (*EUSART_FramingError_InterruptHandler)(void) = ((void*)0);
    static void (*EUSART_OverRunError_InterruptHandler)(void) = ((void*)0);
...
static void EUSART_Baud_Rate_Calculation(const usart_t *_eusart){
    ...
    switch(_eusart->baudrate_gen_config ) {
        case BuadRate_ASYNC_8BIT_LOW_SPEED:
             ...
             TXSTAbits.BRGH = 0;
             BAUDCONbits.BRG16 = 0;
             BaudRate_temp = ((8000000UL / (float)_eusart->baudrate) / 64) - 1;
            break;
        case BuadRate_ASYNC_8BIT_HIGH_SPEED:
             TXSTAbits.SYNC = 0;
             TXSTAbits.BRGH = 1;
             BAUDCONbits.BRG16 = 0;
             BaudRate_temp = ((8000000UL / (float)_eusart->baudrate) / 16) - 1;
            break;
        ...
        case BuadRate_ASYNC_16BIT_HIGH_SPEED:
             ...
             TXSTAbits.BRGH = 1;
             BAUDCONbits.BRG16 = 1;
             BaudRate_temp = ((8000000UL / (float)_eusart->baudrate) / 4) - 1;
            break;
