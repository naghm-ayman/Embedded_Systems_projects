...
# 14 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../std_libiraries.h" 2
...
Std_ReturnType lcd_4bit_intialize(const chr_lcd_4bit_t *lcd){
    ...
    uint8 l_data_pin_counter = 0;
     if(((void*)0) == lcd){
         ...
         ret = lcd_4bit_send_comand(lcd, 0x38);
         _delay((unsigned long)((5)*(8000000UL/4000.0)));
         ret = lcd_4bit_send_comand(lcd, 0x38);
         _delay((unsigned long)((150)*(8000000UL/4000000.0)));
         ret = lcd_4bit_send_comand(lcd, 0x38);
         ret = lcd_4bit_send_comand(lcd, 0x01);
         ret = lcd_4bit_send_comand(lcd, 0x02);
         ret = lcd_4bit_send_comand(lcd, 0x06);
         ret = lcd_4bit_send_comand(lcd, 0x0C);
         ret = lcd_4bit_send_comand(lcd, 0x28);
...
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, const uint8 _char[], uint8 mem_pos){
    ...
    uint8 l_counter = 0;
     if(((void*)0) == lcd){
         ...
         ret = lcd_4bit_send_comand(lcd,(0x40 + (mem_pos*8)));
...
Std_ReturnType lcd_8bit_intialize(const chr_lcd_8bit_t *lcd){
    ...
    uint8 l_data_pin_counter = 0;
     if(((void*)0) == lcd){
         ...
         ret = gpio_pin_intialize(&(lcd->LCD_rs));
         ret = gpio_pin_intialize(&(lcd->LCD_en));
         for(l_data_pin_counter = 0; l_data_pin_counter < 8; l_data_pin_counter++){
             ret = gpio_pin_intialize(&(lcd->LCD_data[l_data_pin_counter]));
         }
         _delay((unsigned long)((20)*(8000000UL/4000.0)));
         ret = lcd_8bit_send_comand(lcd, 0x38);
         _delay((unsigned long)((5)*(8000000UL/4000.0)));
         ret = lcd_8bit_send_comand(lcd, 0x38);
         _delay((unsigned long)((150)*(8000000UL/4000000.0)));
         ret = lcd_8bit_send_comand(lcd, 0x38);
         ret = lcd_8bit_send_comand(lcd, 0x01);
         ret = lcd_8bit_send_comand(lcd, 0x02);
         ret = lcd_8bit_send_comand(lcd, 0x06);
         ret = lcd_8bit_send_comand(lcd, 0x0C);
         ret = lcd_8bit_send_comand(lcd, 0x38);
...
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, const uint8 _char[], uint8 mem_pos){
    ...
    uint8 l_counter = 0;
     if(((void*)0) == lcd){
         ...
         ret = lcd_8bit_send_comand(lcd,(0x40 + (mem_pos*8)));
         for(l_counter = 0; l_counter <= 7; l_counter++){
...
static Std_ReturnType lcd_4_bits_set_cusor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column){
    ...
    column--;
    switch(row){
        case 1 : ret = lcd_4bit_send_comand(lcd, (0x80 + column));
        break;
        case 2 : ret = lcd_4bit_send_comand(lcd, (0xc0 + column));
        break;
        case 3 : ret = lcd_4bit_send_comand(lcd, (0x94 + column));
        break;
        case 4 : ret = lcd_4bit_send_comand(lcd, (0xd4 + column));
        break;
        default : ;
    }
...
static Std_ReturnType lcd_8_bits_set_cusor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column){
    ...
    column--;
    switch(row){
        case 1 : ret = lcd_8bit_send_comand(lcd, (0x80 + column));
        break;
        case 2 : ret = lcd_8bit_send_comand(lcd, (0xc0 + column));
        break;
        case 3 : ret = lcd_8bit_send_comand(lcd, (0x94 + column));
        break;
        case 4 : ret = lcd_8bit_send_comand(lcd, (0xd4 + column));
        break;
        default : ;
    }
