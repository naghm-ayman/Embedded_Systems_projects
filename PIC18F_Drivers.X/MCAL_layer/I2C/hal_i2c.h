...
#define SLEW_RATE_DISABLED 1
#define SLEW_RATE_ENABLED  0

/* SMBus Select bit */
#define SMBus_INPUT_ENABLED  1
#define SMBus_INPUT_DISABLED 0

/* Slave Mode Data/Address Indication */
#define I2C_LAST_BYTE_TX_RX_DATA     1
#define I2C_LAST_BYTE_TX_RX_ADRESSS  0
...
/* Master Synchronous Serial Port Config */
...
/* Clock Stretch in Slave Mode */
#define CLOCK_STRETCH_ENABLE()   (SSPCON1bits.CKP = 1)
#define CLOCK_STRETCH_DISABLE()  (SSPCON1bits.CKP = 0)
...
typedef struct{
    ...
    i2c_config_t i2c_config; /* I2C Configurations */
#if I2C_INTERRUPT_FEATURE_ENABLE == INTERRUPT_FEATURE_ENABLE
